...
export interface UserWorkDays {
  Monday: {active: boolean, hours: string[] | undefined};
  Tuesday: {active: boolean, hours: string[] | undefined};
  Wednesday: {active: boolean, hours: string[] | undefined};
  Thursday: {active: boolean, hours: string[] | undefined};
  Friday: {active: boolean, hours: string[] | undefined};
  Saturday: {active: boolean, hours: string[] | undefined};
  Sunday: {active: boolean, hours: string[] | undefined};
}
